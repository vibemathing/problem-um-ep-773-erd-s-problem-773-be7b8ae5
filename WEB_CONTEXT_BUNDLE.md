...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-773-erd-s-problem-773-be7b8ae5-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-773"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-773-erd-s-problem-773-be7b8ae5-v1",
      "problem_contract_sha256": "876acaa1595781bd1d72fe64ec484e413d8dfb0cd3a4839481d6830dcb5e7d1b",
      "problem_id": "problem:um-ep-773-erd-s-problem-773-be7b8ae5",
      "route_id": "route:um-ep-773-erd-s-problem-773-be7b8ae5-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-773-erd-s-problem-773-be7b8ae5-source-fidelity-01",
      "graph_id": "graph:um-ep-773-erd-s-problem-773-be7b8ae5-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-773-erd-s-problem-773-be7b8ae5-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-773-erd-s-problem-773-be7b8ae5-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "What is the size of the largest Sidon subset $A\\subseteq\\{1,2^2,\\ldots,N^2\\}$? Is it $N^{1-o(1)}$?"
          },
          "statement_sha256": "ecb6825273dfc22a707dee0b6736e9e5c70f92f96d078cb6ec92f10f3ddda3ed"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-773-erd-s-problem-773-be7b8ae5-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-773-erd-s-problem-773-be7b8ae5-root",
      "route_id": "route:um-ep-773-erd-s-problem-773-be7b8ae5-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-773-59a312d380cb",
        "url": "https://www.unsolvedmath.com/problems/EP-773"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
